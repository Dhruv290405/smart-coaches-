...
class BCAlertsView extends StatelessWidget {
  final List<Map<String, dynamic>> alerts;

  const BCAlertsView({super.key, required this.alerts});
        ...
        if (alerts.isEmpty)
          Center(
            child: Padding(
              ...
              child: Text('No active alerts', style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey)),
            ),
          )
        else
  ...
  Widget _buildAlertCard(Map<String, dynamic> alert) {
    ...
    if (type == 'critical') {
      ...
      iconColor  = const Color(0xFFBE8B22);
      titleColor = const Color(0xFFBE8B22);
      textColor  = const Color(0xFFD5991D);
    } else {
